...
class ZCodeVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by ZCodeParser#arrayobj.
    def visitArrayobj(self, ctx:ZCodeParser.ArrayobjContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ZCodeParser#ifexpr.
